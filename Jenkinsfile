pipeline {
  agent {
    kubernetes {
      label 'xtext-xtend-' + (env.BRANCH_NAME.replace('/','_')) + '-' + env.BUILD_NUMBER
...
spec:
  ...
  parameters {
    choice(name: 'target_platform', choices: ['oxygen', 'photon', 'r201812', 'r201809', 'r201903', 'r201906', 'r201909', 'r201912', 'r202003', 'latest'], description: 'Which Target Platform should be used?')
    booleanParam(
